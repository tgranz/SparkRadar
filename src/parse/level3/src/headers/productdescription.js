...
const parseProductDescription = (raf, product) => {
...
const parse = parseProductDescription;
...
export { parse, parseProductDescription, MODE_MAINTENANCE, MODE_CLEAN_AIR, MODE_PRECIPITATION };
